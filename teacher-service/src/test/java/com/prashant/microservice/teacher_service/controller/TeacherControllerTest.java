package com.prashant.microservice.teacher_service.controller;
...
import com.prashant.microservice.teacher_service.service.TeacherService;
...
public class TeacherControllerTest {
	...
	void getTeachers_shouldReturnTeachersList_whenTeachersListNotNull() throws Exception {
	    ...
	    when(teacherService.getTeachers(any(Pageable.class))).thenReturn(page);
		
		mockMvc.perform(get("/teacher/paginated?page=0&size=10"))
	...
	void getStudentsShouldGetAllStudentDetailsWhenNotNull() throws Exception {
		...
		when(teacherService.getStudents(any(Pageable.class))).thenReturn(page);

		
		mockMvc.perform(get("/teacher/allStudents?page=0&size=10"))
				.andExpect(status().isOk())
